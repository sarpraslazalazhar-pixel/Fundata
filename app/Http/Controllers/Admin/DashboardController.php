...
class DashboardController extends Controller
{
    public function index(Request $request)
    {
        ...
        $cacheKey = "admin_dashboard_data_{$year}_{$month}";

        $dashboardData = \Illuminate\Support\Facades\Cache::remember($cacheKey, 60 * 15, function () use ($month, $year) {
            ...
            return [
                ...
                'distribusiMetode' => $distribusiMetode->toArray(),
                'topFundraiser' => $topFundraiser->toArray(),
                'topDonatur' => $topDonatur->toArray(),
                'riwayatTransaksi' => $riwayatTransaksi->toArray(),
                'followUpTickets' => $followUpTickets->toArray(),
        ...
        return Inertia::render('Admin/Dashboard/Index', array_merge($dashboardData, [
