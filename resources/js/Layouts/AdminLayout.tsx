...
export default function AdminLayout({ children, title }: AdminLayoutProps) {
 ...
 <Link href="/admin/logout" method="post" as="button" className="flex w-full cursor-pointer items-center gap-2 px-2 py-1.5 text-sm text-red-600 transition-colors hover:bg-red-50 rounded-md">
