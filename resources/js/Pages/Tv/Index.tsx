...
`Tiket baru: ${t.formatted_id} - ${t.user?.name || '-'}`,
 ...
 badgeStyle = 'bg-primary/100 text-white text-sm px-4 py-1.5 font-bold tracking-wider uppercase shadow-md shadow-sky-200 border-primary';
 cardStyle = 'bg-gradient-to-br from-sky-50 to-white border-primary/20 shadow-md shadow-sky-100/50';
 } else if (isFuture) {
 if (isToday) {
