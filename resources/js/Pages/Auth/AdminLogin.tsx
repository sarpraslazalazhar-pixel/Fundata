...
export default function AdminLogin() {
 ...
 return (
 <>
 <Head title="Admin Login - Fundata" />
 <style>
 {`
 .login-wrapper {
...
`}
 ...
 <div className="mt-4 bg-[#0F7B46]/10 text-[#0F7B46] px-4 py-1 rounded-full text-sm font-semibold uppercase tracking-wider">
 Admin Panel
 </div>
 </div>
 ...
 Username / Email Admin<span className="text-red-500">*</span>
 </label>
