...
export default function UserLogin() {
 ...
 bottom: 0;
 width: 33%;
 background: linear-gradient(90deg, rgba(15, 123, 70, 0.7) 0%, rgba(15, 123, 70, 0.4) 50%, transparent 100%);
 pointer-events: none;
 }
`}
 </style>
 ...
 <input
 className="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg focus:ring-[#0F7B46] focus:border-[#0F7B46] text-sm"
 id="username"
 name="username"
 ...
 <input
 className="block w-full pl-10 pr-10 py-2 border border-gray-300 rounded-lg focus:ring-[#0F7B46] focus:border-[#0F7B46] text-sm"
 id="password"
 name="password"
 ...
 <input
 className="h-4 w-4 text-[#0F7B46] rounded border-gray-300 focus:ring-[#0F7B46]"
 id="remember"
 type="checkbox"
 ...
 <Link className="text-xs font-medium text-[#0F7B46] hover:underline" href="/lupa-password">Lupa password?</Link>
 </div>

 {/* Submit Button */}
 <button
 className="w-full bg-[#0F7B46] hover:bg-[#0c6037] text-white font-semibold py-3 rounded-lg flex items-center justify-center gap-2 transition duration-200 mt-2 disabled:opacity-70"
 type="submit"
 disabled={processing}
 >
 ...
 Belum punya akun? <Link href="/register" className="font-semibold text-[#0F7B46]">Hubungi Admin</Link>
 </div>
 </form>
 </section>
 ...
 <h4 className="text-3xl font-bold mb-6 text-[#0F7B46] drop-shadow-sm">PLATFORM LAYANAN TERPADU</h4>
 ...
 © 2026 Fundata - Al Azhar Peduli Umat. All rights reserved.
 </footer>
 </main>
 </>
 );
