...
export default function Register() {
 ...
 return (
 <>
 <Head title="Daftar Akun - Fundata" />
 <style>
 {`
 .login-wrapper {
...
`}
 ...
 <Link
 href="/login"
 className="inline-flex w-full justify-center rounded-lg border border-gray-300 bg-white py-2 px-4 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-[#0F7B46] focus:ring-offset-2 transition-colors"
 >
