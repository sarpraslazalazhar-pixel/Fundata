...
function IconPicker({ selectedIcon, onSelect }: { selectedIcon: string; onSelect: (icon: string) => void }) {
 ...
 <div className="p-1 bg-primary/100/10 rounded border border-primary/20">
 ...
 isSelected 
 ? 'bg-primary/100 text-white shadow-sm ring-2 ring-primary ring-offset-1' 
...
export default function UnitIndex({ units, filters }: { units: any; filters?: { search?: string } }) {
 ...
 <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-lg bg-primary/100/10 text-primary border border-primary/20/50 ">
