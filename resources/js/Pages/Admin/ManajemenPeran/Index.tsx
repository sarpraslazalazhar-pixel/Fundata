...
export default function Index({ roles, permissions }: Props) {
 ...
 <div>
 <h1 className="text-2xl font-bold tracking-tight text-slate-900 ">Manajemen Peran</h1>
 ...
 <label className="text-sm font-medium text-slate-700 ">Nama Peran <span className="text-red-500">*</span></label>
 <Input
 value={data.name}
 ...
 <label className="text-sm font-medium text-slate-700 ">Hak Akses Modul</label>
