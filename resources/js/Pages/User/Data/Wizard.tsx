...
function ReviewRow({ label, value }: { label: string; value: React.ReactNode }) {
 ...
 <ReviewSection title="Pilihan Kategori" icon={<CheckCircle2 className="w-4 h-4 text-green-500" />}>
 <ReviewRow label="Kategori Data" value={getSelectedName(unitList, data.unit_id)} />
 <ReviewRow label="Jenis Data" value={subUnits.options.find((s: any) => String(s.id) === String(data.sub_unit_id))?.nama_layanan || '-'} />
 </ReviewSection>
